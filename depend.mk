...
./build/check_Hermicity.o : ./build/system.o ./build/kinds.o 
./build/dump_vec_io.o : ./build/io_global.o ./build/kinds.o 
./build/R_vector.o : ./build/kpoints.o ./build/wannier90.o ./build/constants.o ./build/unique.o ./build/system.o ./build/io_global.o ./build/kinds.o 
...
./build/wannier90.o : ./build/constants.o ./build/lin_eig_H.o ./build/dump_vec_io.o ./build/system.o ./build/mp_base.o ./build/kpoints.o ./build/io_global.o ./build/kinds.o 
